...
5. Materiais acessíveis, máximo 6 itens, com quantidades precisas sempre que possível. PROIBIDO usar base de papelão, cartolina ou caixas de papelão como material-padrão; use-os apenas se forem a escolha mais coerente para o produto final. A IA deve escolher materiais adequados ao problema: às vezes apenas lápis e papel são suficientes; outras vezes fios, sensores, sementes, água, régua, calculadora, dados, fichas, elástico, palito ou materiais recicláveis variados. Nunca repita o mesmo tipo de material de atividade em atividade. Varie o formato conforme o tema: experimento, maquete, circuito ou sensor simulado, jogo de tabuleiro, mapa, modelo 3D, protótipo estrutural, planilha física/digital, instalação ou investigação com instrumentos simples. Formato obrigatório para "materialFunctions": "Nome: quantidade por grupo — finalidade." Exemplos de formato, não de lista fixa: "Material estrutural escolhido: quantidade por grupo — base ou suporte.", "Elementos móveis: quantidade por grupo — simulação e teste.", "Instrumento de medida ou registro: quantidade por grupo — coleta de evidências." Para uso coletivo: "Projetor: 1 para a turma — apresentação inicial." Para materiais de risco (cola quente, estilete, solda), adicionar: " — uso com supervisão do professor."
...
28. PROIBIDO repetir base de papelão, painel de cartolina, caixas ou fichas coladas como solução padrão. A criatividade é obrigatória: escolha materiais e mecânica de teste completamente diferentes a cada geração. Para temas simples, pense em atividades resolvíveis só com lápis, papel e imaginação. Para temas práticos, prefira materiais manipuláveis, reutilizáveis ou do cotidiano. Nunca use estrutura física só por ser "segura" — use-a quando for a melhor solução pedagógica.
